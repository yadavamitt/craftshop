...
const Navbar: React.FC = () => {
    ...
    return (
        <>
            <header className="sticky top-0 bg-white bg-opacity-90 backdrop-blur-sm shadow-sm z-50">
                <nav className="container mx-auto px-6 h-20 relative flex items-center justify-center">
                    {/* Left: Desktop Nav */}
                    <div className="absolute left-6 top-1/2 -translate-y-1/2 hidden md:flex items-center space-x-8 lg:space-x-12">
                        <NavItem to="/">Home</NavItem>
                        <NavItem to="/shop">Shop</NavItem>
                        <NavItem to="/our-journey">Our Journey</NavItem>
                        <NavItem to="/contact">Contact</NavItem>
                    ...
                    <div className="absolute right-6 top-1/2 -translate-y-1/2 flex items-center space-x-4">
                        <button
                            ...
                            className="text-gray-500 hover:text-brand-dark transition-colors duration-300"
                        ...
                        <div className="md:hidden">
                            <button onClick={() => setIsMobileMenuOpen(!isMobileMenuOpen)} className="text-brand-dark" aria-label="Toggle menu">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                    {isMobileMenuOpen ? <line x1="18" y1="6" x2="6" y2="18"></line> : <line x1="3" y1="12" x2="21" y2="12"></line>}
                                    {isMobileMenuOpen ? <line x1="6" y1="6" x2="18" y2="18"></line> : <line x1="3" y1="6" x2="21" y2="6"></line>}
                                    {isMobileMenuOpen ? null : <line x1="3" y1="18" x2="21" y2="18"></line>}
                                </svg>
                            </button>
                        </div>
                    </div>
                ...
                <div className={`md:hidden transition-all duration-300 ease-in-out ${isMobileMenuOpen ? 'max-h-screen opacity-100' : 'max-h-0 opacity-0 overflow-hidden'}`}>
                    <div
                        className="flex flex-col items-center space-y-4 py-4 border-t border-gray-200"
